...
\begin{equation} \label{eq:regression}
	\hat{\boldsymbol{\uptheta}} = (\mathbf{X}^T \mathbf{X})^{-1} \mathbf{X}^T \mathbf{Y},
\end{equation}
...
Once a subset of features are chosen equation \ref{eq:linearModel} is utilized to create a two variable model. If two features are selected, for example take kurtosis and mean, then the model is given by
\begin{equation}
...
\begin{figure}[H]
    \centering
		\begin{subfigure}{.5\textwidth}
		  \centering
    			\includegraphics[width=.9\linewidth]{figures/Models_Feature2Signal1.eps}
		  	\caption{Feature values}
		  	\label{fig:Models_Feature2Signal9}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
		  \centering
 		   	\includegraphics[width=.9\linewidth]{figures/Models_Feature2Signal1_Linear1.eps}
		  	\caption{Linear Model}
...
\begin{figure}[H]
    \centering
		\begin{subfigure}{.5\textwidth}
		  \centering
    			\includegraphics[width=.9\linewidth]{figures/Models_Feature4Signal9.eps}
		  	\caption{Feature values}
		  	\label{fig:Models_Feature4Signal9}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
		  \centering
 		   	\includegraphics[width=.9\linewidth]{figures/Models_Feature4Signal9_Linear1.eps}
		  	\caption{Linear Model}
