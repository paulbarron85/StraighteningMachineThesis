...
\begin{figure}[H]
    ...
    \centering
		\begin{subfigure}{.45\textwidth}
		  \centering
    			\includegraphics[width=.9\linewidth]{figures/Models_Signal3Feature10.eps}
		  	\caption{Feature values}
		  	\label{fig:Models_Signal3Feature111}
		\end{subfigure}\hspace{\fill} % maximize horizontal separation
		\begin{subfigure}{.45\textwidth}
		  \centering
 		   	\includegraphics[width=.9\linewidth]{figures/Models_Signal3Feature10_Linear1.eps}
		  	\caption{Linear model 1}
		  	\label{fig:Models_Signal3Feature10_Linear1}
		\end{subfigure}
		\bigskip
		\begin{subfigure}{.45\textwidth}
		  \centering
    			\includegraphics[width=.9\linewidth]{figures/Models_Signal3Feature10_Linear2.eps}
		  	\caption{Linear model 2}
		  	\label{fig:Models_Signal3Feature10_Linear2}
		\end{subfigure}\hspace{\fill} % maximize horizontal separation
		\begin{subfigure}{.45\textwidth}
		  \centering
 		   	\includegraphics[width=.9\linewidth]{figures/Models_Signal3Feature10_Multivariate1.eps}
		  	\caption{Multivariate Model}
		  	\label{fig:Models_Signal3Feature10_Multivariate1}
		\end{subfigure}
    \caption{Signal 3, 21:12 Actual moment over Rolls Feature 10 Shape Factor}
    \label{fig:Models_Signal3Feature11_Caption}
\end{figure}
\end{comment}
