...
An analysis of the raw signals was performed using R2 correlation. Table \ref{correlationTable} shows stuff.
\begin{center}
...
Figure \ref{fig:RawSignalCorrelationsFile1} is highly linear and from Table \ref{correlationTable} has an R2 correlation value of 0.99. This means that there is not much value to be gained by including bother of these signals and likely one can be exluded from analysis.
\begin{figure}[!ht]
    \centering
