...
The application of CM and predictive maintenance (\gls{PM}) is a large area of research in the machine and manufacturing industry. Of course it is not only limited to machines being utilized on other engineering structures like bridges ~\cite{buckley2023feature}, large process plants such as waster water and also biological systems. 
...
On the Stability and Homogeneous Ensemble of Feature Selection for Predictive Maintenance: 
