...
Once a subset of features are chosen equation \ref{eq:linearModel} is used to create a model. If two features are selected, for example take kurtosis and mean, then the model is given by
\begin{equation}
...
It can be noted in \cref{fig:FeatureVsFeatureCombinedSignal3} that Features 1, 2 and 3 all have very straight lines for the plots so here we can say that these features (Clearance, Crest and Impulse Factor), are linearly correlated with correlation values between x-y, and need only include one of these in any model. This is the same situation for Features 5, 6 and 7.
    ...
    \centering
		...
		\begin{subfigure}{.45\textwidth}
		  \centering
		  	...
		  	\caption{Band power vs Shape factor with data points in color ordered in time and linear model in red with Fit = 26.2.}
		...
		\begin{subfigure}{.45\textwidth}
		  \centering
		  	...
		  	\caption{Band power vs Standard Deviation with data points in color ordered in time and linear model in red with Fit = 48.1.}
		...
		\begin{subfigure}{.45\textwidth}
		  \centering
		  	...
		  	\caption{Multivariate Model of Shape Factor, Standard Deviation and Band Power with Fit = 61.5.}
...
\begin{figure}[H]
    \centering
		...
		\begin{subfigure}[t]{.45\textwidth}
		  	...
		  	\caption{Crest factor vs Band power with data points in color ordered in time and linear model in red with Fit = 33.7.}
...
\begin{figure}[H]
    \centering
		...
		\begin{subfigure}[t]{.45\textwidth}
		  	...
		  	\caption{RMS vs Standard Deviation with data points in color ordered in time and linear model in red with Fit = 17.9.}
    ...
    \centering
		...
		\begin{subfigure}[t]{.45\textwidth}
		  \centering
		  	...
		  	\caption{Skewness vs Kurtosis with data points in color ordered in time and linear model in red with Fit = 41.7.}
		...
		\begin{subfigure}[t]{.45\textwidth}
		  \centering
		  	...
		  	\caption{Skewness vs Mean with data points in color ordered in time and linear model in red with Fit = 17.6.}
		  	\label{fig:Models_Signal9Feature11_Linear2}
		\end{subfigure}\hspace{\fill} % maximize horizontal separation
		\begin{subfigure}[t]{.45\textwidth}
		  \centering
 		   	\includegraphics[width=.95\linewidth]{figures/Models_Signal9Feature11_Linear3.eps}
		  	\caption{Skewness vs Shape Factor with data points in color ordered in time and linear model in red with Fit = 44.7.}
...
\Cref{fig:Models_Signal10Feature11_Caption} plots two features for Signal 10, Width error. \Cref{fig:Models_Signal10Feature11_Linear1} shows a clear non-linear parabolic relationship between the Skewness and the Kurtosis.
\begin{figure}[H]
    \centering
		\begin{subfigure}[t]{.45\textwidth}
		  \centering
		...
		\begin{subfigure}[t]{.45\textwidth}
		  \centering
		  	...
		  	\caption{Skewness vs Kurtosis with data points in color ordered in time and linear model in red with Fit = 16.6.}
    ...
    \centering
		...
		\begin{subfigure}[t]{.45\textwidth}
		  \centering
		  	...
		  	\caption{Clearance Factor vs Shape Factor with data points in color ordered in time and linear model in red with Fit = 59.1.}
		...
		\begin{subfigure}[t]{.45\textwidth}
		  \centering
		  	...
		  	\caption{Clearance vs Skewness Band power vs Crest factor with data points in color ordered in time and linear model in red with Fit = 27.5.}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{.45\textwidth}
		...
		\caption{Angle over Rolls vs Vibration with data points in color ordered in time and linear model in red with Fit = 17.}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{.45\textwidth}
		...
		\caption{Height Error vs Height Position with data points in color ordered in time and linear model in red with Fit = 23.8.}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{.45\textwidth}
	  \centering
	  	...
	  	\caption{Actual moment under Rolls vs Actual Moment under Rolls with data points in color ordered in time and linear model in red with Fit = 33.6.}
